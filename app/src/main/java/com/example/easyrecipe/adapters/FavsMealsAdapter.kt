...
import com.example.easyrecipe.databinding.MealItemBinding
import com.example.easyrecipe.fragments.FavoritesFragment
import com.example.easyrecipe.pojo.Meal

class FavsMealsAdapter() :
    RecyclerView.Adapter<FavsMealsAdapter.FavoritesMealsAdapterViewHolder>() {
