...
import com.example.easyrecipe.databinding.FragmentFavoritesBinding
...
class FavoritesFragment : Fragment() {
    ...
    private lateinit var favoritesAdapter:FavsMealsAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ItemTouchHelper(itemTouchHelper).attachToRecyclerView(binding.rvFavs)
    }

    private fun prepareRecyclerView() {
        favoritesAdapter = FavsMealsAdapter()
